...
At first, we assume that our system is only composed of well defined functions. In other words, for a given set of inputs, the system is deterministic.\\
...
Our analysis is based on the java source code. TODO\\
